...
import com.eggetteluo.todayclass.core.time.CourseStatus
import com.eggetteluo.todayclass.core.time.getCourseStatus
...
fun CourseItemCard(
    ...
    val timeRange = remember(course.startPeriod, course.periodCount, course.location) {
        getFormattedTimeRange(course.startPeriod, course.periodCount, course.location)
    }
    val status = remember(timeRange, isToday, refreshTick) {
        getCourseStatus(timeRange, isToday)
    }
        ...
        Row(
                ...
                modifier = Modifier
                    ...
                    .background(
                        color = if (status == CourseStatus.FINISHED) {
                            ...
                            courseColor.copy(alpha = if (status == CourseStatus.ONGOING) pulseAlpha else 0.7f)
                        },
            ...
            Column(
                ...
                Row(
                    ...
                    TeacherChip(
                        name = course.teacher.ifBlank { "未标注" },
                        isGray = status == CourseStatus.FINISHED,
                    )
                }
                ...
                Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
                    ...
                    InfoItem(
                        ...
                        text = "第 ${course.startPeriod}-${course.startPeriod + course.periodCount - 1} 节 ($timeRange)",
